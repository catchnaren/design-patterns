...
class MyDatabase {
  constructor() {
    ...
    // console.log({ capitals: this.capitals });
  }
...
describe('singleton database', function () {
  it('is a singleton', function () {
    ...
    // console.log({ population: db1.getPopulation('Tokyo ') });
    expect(db1).toBe(db2);
  });
  ...
  it('calculates total population', function () {
    ...
    let tp = rf.totalPoupulation(cities);
    expect(tp).toEqual(17400000 + 17500000);
  });

  it('calculaters total population better', function () {
